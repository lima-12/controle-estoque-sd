...
<head>
    ...
    <title>Stok - Nova Filial</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" />
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
    <link rel="stylesheet" href="../../assets/css/filiais/create.css">
...
<body>
    ...
    <div class="filial-create-container px-4">
        <!-- Breadcrumb -->
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow">
                    <div class="card-header">
                        <h4 class="mb-0">
                            <i class="fas fa-building me-2"></i>Nova Filial
                        </h4>
                    </div>
                    <div class="card-body">
                        <form id="filialForm">
    ...
    <script src="../../assets/js/filiais/create.js"></script>
</body>
</html>
